...
namespace App\Models\Patient\Traits\Attribute;
...
trait Attribute
{
    ...
    {
        $repository = new EloquentPatientRepository;
    ...
    public function getAdminActionButtonsAttribute()
    {
        ...
        return 'N/A';//$this->getEditButtonAttribute($routes, $repository->adminRoutePrefix, true) ;
