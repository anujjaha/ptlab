<?php namespace App\Models\TableField\Traits\Attribute;
...
use App\Repositories\TableField\EloquentTableFieldRepository;
...
trait Attribute
{
    ...
    {
        $repository = new EloquentTableFieldRepository;
