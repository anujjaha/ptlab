...
namespace App\Models\SubCasteDivision\Traits\Attribute;
...
use App\Repositories\SubCasteDivision\EloquentSubCasteDivisionRepository;
...
trait Attribute
{
    ...
    {
        $repository = new EloquentSubCasteDivisionRepository;
