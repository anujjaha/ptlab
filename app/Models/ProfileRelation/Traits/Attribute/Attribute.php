...
namespace App\Models\ProfileRelation\Traits\Attribute;
...
use App\Repositories\ProfileRelation\EloquentProfileRelationRepository;
...
trait Attribute
{
    ...
    {
        $repository = new EloquentProfileRelationRepository;
