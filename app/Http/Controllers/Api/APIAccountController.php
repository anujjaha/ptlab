...
class APIAccountController extends BaseApiController
{
    ...
    public function index(Request $request)
    {
        ...
        {
            $itemsOutput = $this->accountTransformer->transformCollection($items);
    ...
    public function store(Request $request)
    {
        ...
        if($model)
        {
            $responseData = $this->accountTransformer->transform($model);

            return $this->successResponse($responseData, 'Account is Created Successfully');
        }
    ...
    public function show(Request $request, $id = null)
    {
        ...
        if($itemId)
        {
            ...
            if($itemData)
            {
                $responseData = $this->accountTransformer->transform($itemData);
    ...
    public function update(Request $request, $id = null)
    {
        ...
        if($itemId)
        {
            ...
            if($status)
            {
                ...
                return $this->successResponse($responseData, 'Account is Edited Successfully');
            }
        }
