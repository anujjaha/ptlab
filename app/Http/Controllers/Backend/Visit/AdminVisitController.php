...
class AdminVisitController extends Controller
{
     ...
     * @var string
     */
    protected $createSuccessMessage = "Visit Created Successfully!";
     ...
     * @var string
     */
    protected $editSuccessMessage = "Visit Edited Successfully!";
     ...
     * @var string
     */
    protected $deleteSuccessMessage = "Visit Deleted Successfully";
